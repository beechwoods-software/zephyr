					...
					uint32_t mask, uint32_t value)
{
    ...
    printf("gpio_rpi_port_set_masked_raw %x %d\n", mask, value); return 0;
...
{
	struct gpio_rpi_data *data = port->data;
    printf("gpio_rpi_port_set_bits_raw %d\n", pins); return 0;
	/* First handle push-pull pins: */
...
{
	struct gpio_rpi_data *data = port->data;
    printf("gpio_rpi_port_clear_bits_raw %d\n", pins); return 0;
	/* First handle push-pull pins: */
...
{
	struct gpio_rpi_data *data = port->data;
    printf("gpio_rpi_port_toggle_bits %d\n", pins); return 0;
	/* First handle push-pull pins: */
						...
						enum gpio_int_trig trig)
{
    ...
    printf("gpio_rpi_pin_interrupt_configure %d\n", pin); return 0;
