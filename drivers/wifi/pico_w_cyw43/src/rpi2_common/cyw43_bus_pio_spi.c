...
#else
#define SPI_PROGRAM_FUNC spi_gap01_sample0_program
#define SPI_PROGRAM_GET_DEFAULT_CONFIG_FUNC spi_gap01_sample0_program_get_default_config
#define SPI_OFFSET_END spi_gap01_sample0_offset_end
#define SPI_OFFSET_LP1_END spi_gap01_sample0_offset_lp1_end
#endif
